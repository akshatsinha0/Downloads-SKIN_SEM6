...
{\Large\bfseries BCSE497J -- Project -- I\par}
...
{\itshape Projects and Internship\par}
{\itshape Class Id: VL2025260102304\par}

\vfill

{\Large\bfseries Team\par}
\vspace{0.5cm}
% Centered, compact block (overall centered; names in bold)
...
{\bfseries B.Tech.\par}
{\itshape in\par}
{\bfseries Computer Science and Engineering (Core)\par}
...
\begin{center}
{\fontsize{14pt}{18pt}\selectfont\bfseries\MakeUppercase{Abstract}\par}
\end{center}
...
% === Third page: TABLE OF CONTENTS (manual table) ===
\clearpage
% Roman numerals continue here (ii, iii, ...)

% Heading: 14 pt, Bold, UPPER CASE
\begin{center}
{\fontsize{14pt}{18pt}\selectfont\bfseries\MakeUppercase{Table of Contents}\par}
\end{center}

% Contents: Times 12 pt, compact line spacing
\setstretch{1.2}
\renewcommand{\arraystretch}{1.05}

% Three-column grid: Sl.No | Contents | Page No.
{\small
\noindent\begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}p{1.4cm}|X|>{\centering\arraybackslash}p{2.2cm}|}
\hline
...
\hline
\textbf{2.} & \textbf{PROJECT DESCRIPTION AND GOALS} & 2 \\
...
\hline
\textbf{3.} & \textbf{REQUIREMENT ANALYSIS } & 3 \\
...
% Restore your default spacing for subsequent pages if needed
\setstretch{1.2}

% (Next page: switch to Arabic numbering and start Section 1)
% \clearpage
% \pagenumbering{arabic}
% \setcounter{page}{1}


% === Main matter: INTRODUCTION (start Arabic page numbering at 1) ===
\clearpage
\pagenumbering{arabic}
\setcounter{page}{1}
