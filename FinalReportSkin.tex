...
\definecolor{pagebg}{HTML}{FFFFFD}
\pagecolor{pagebg}
...
\noindent \textbf{Dr. Boominathan P}
...
\textbf{6.} & \hyperlink{chapter6}{\textbf{PROJECT DEMONSTRATION}} & \textbf{9} \\
 & 6.1 Project Links & 9 \\
 & 6.2 System Interface & 9 \\
 & 6.3 Demonstration Workflow & 9 \\
 & 6.4 Example Outputs & 9 \\
 & 6.5 Performance Characteristics & 9 \\
\hline
...
\hline
2.1 & Work Breakdown Structure (WBS) & \pageref{fig:wbs} \\
\hline
2.2 & Activity chart (Gantt) aligned to Phases 1--5 & \pageref{fig:activity-gantt} \\
\hline
4.1 & Two-stage system: image/text encoders, gated fusion with prototypes, calibrated softmax, selection head, and controlled prompting & \pageref{fig:system-design} \\
\hline
4.2 & Level 0 Data Flow Diagram showing the high-level context of the multimodal skin lesion diagnosis system & \pageref{fig:level0-dfd} \\
\hline
4.3 & Level 2 Data Flow Diagram providing detailed view of internal processes & \pageref{fig:level2-dfd} \\
\hline
4.4 & Use Case Diagram showing the primary actors and their interactions with the system & \pageref{fig:usecase} \\
\hline
4.5 & Class Diagram showing the object-oriented structure of the system components & \pageref{fig:class-diagram} \\
\hline
4.6 & Sequence Diagram showing the temporal flow of interactions between system components during a typical diagnostic workflow & \pageref{fig:sequence-diagram} \\
\hline
6.1 & Streamlit dashboard showing diagnostic report generation interface with multilingual support & \pageref{fig:stream1} \\
\hline
6.2 & Streamlit interface displaying image upload, patient metadata input, and real-time diagnosis & \pageref{fig:stream2} \\
\hline
\end{tabularx}
...
\hline
7.1 & Performance comparison on implemented datasets & \pageref{tab:performance} \\
\hline
\end{tabularx}
...
The complete source code and live demonstration of the system are available at:

\begin{itemize}
  \item \textbf{GitHub Repository:} \url{https://github.com/amanchauhan786/Multimodal_Lesion_Based.git}
  \item \textbf{Streamlit Dashboard:} \url{https://multimodalskin.streamlit.app/}
\end{itemize}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{stream1.png}
  \caption{Streamlit interface displaying image upload, patient metadata input, and real-time diagnosis with
confidence scores.}
  \label{fig:stream1}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{stream2.png}
  \caption{Streamlit dashboard showing diagnostic report generation interface with multilingual support and patient information display.}
  \label{fig:stream2}
\end{figure}
...
\midrule
EfficientNet-B3 + ClinicalBERT & ISIC 2020 & 2 & 0.90 \\
%ResNet-18 + BERT & HAM10000 & 7 & 0.87 \\
\textbf{EfficientNet-B3 + ClinicalBERT} & HAM10000 & \textbf{7} & \textbf{0.8612} \\
\bottomrule
\end{tabular}
\end{table}
