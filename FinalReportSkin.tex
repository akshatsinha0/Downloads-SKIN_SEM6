...
\begin{center}
{\fontsize{14pt}{21pt}\selectfont\bfseries\MakeUppercase{Table of Contents}\par}
\end{center}
...
\textbf{2.} & \textbf{PROJECT DESCRIPTION AND GOALS} & 2 \\
 & 2.1 Literature Review & 2-3 \\
 & 2.2 Gaps Identified & 3 \\
 & 2.3 Problem Statement & 3 \\
 & 2.4 Project Plan & 3-4 \\
 & 2.5 Activity Chart and Work Breakdown Structure & 4 \\
\hline
\textbf{3.} & \textbf{REQUIREMENT ANALYSIS} & 4 \\
 & 3.1 Datasets and Governance & 4-5 \\
 & 3.2 Functional Requirements & 5 \\
 & 3.3 Data and Preprocessing Requirements & 5 \\
 & 3.4 Model and Baseline Requirements & 5 \\
 & 3.5 Novel Algorithmic Improvement & 5-6 \\
 & 3.6 Evaluation and Quality Requirements & 6 \\
 & 3.7 System and Deployment Requirements & 6 \\
 & 3.8 Risks, Ethics, and Mitigations & 6 \\
 & 3.9 Deliverables & 6 \\
\hline
\textbf{4.} & \textbf{SYSTEM DESIGN} & 6 \\
 & 4.1 Architecture Overview & 6-7 \\
 & 4.2 Components & 7 \\
 & 4.3 Data Flow & 7 \\
 & 4.4 Prompting Template & 7-8 \\
 & 4.5 Deployment Considerations & 8 \\
 & 4.6 Assumptions and Limitations & 8 \\
\hline
\textbf{5.} & \textbf{REFERENCES} & 8 \\
\hline
 & \textbf{Appendix A -- UG-CMGF Method Details} & 12 \\
 & \textbf{Appendix B -- Ablation Protocols} & 13 \\
\hline
\end{tabularx}
}
